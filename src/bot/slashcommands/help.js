        ...
        embeds: [{
          ...
          fields: [
            ...
            },
            {
              inline: false,
              name: 'Support',
              value: 'See `/help event: eventname` for any event you want further clarification on. If something is going horribly wrong, please join the [Wikimedia Discord](https://en.wikipedia.org/wiki/Wikipedia:Discord), open a post under #technical, and ping the bot\'s maintainer, `beef.w`.'
            },
            {
              inline: false,
              name: 'Privacy Policy',
