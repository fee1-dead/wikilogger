...
module.exports = {
  func: async (message, suffix) => {
    ...
    if (num < 5 || num > 1000) return message.channel.createMessage('That number is invalid! Please provide any number between 5 and 1000')
  ...
  category: 'Utility',
  perm: 'manageMessages',
  quickHelp: 'Makes a log online of up to the last 1000 messages in a channel. Does NOT delete any messages.',
